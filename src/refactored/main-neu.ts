...
class Car  {
    ...
    constructor(symbol: string, position: Point, direction: Direction) {
        this.symbol = symbol;
...
class Simulation {
    ...
    run() {
        ...
        while (!carsCrashed) {
            this.carOne.move(this.streetMap);
            this.carTwo.move(this.streetMap);
